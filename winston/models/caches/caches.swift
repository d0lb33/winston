...
class Caches {
  ...
  static let postsPreviewModels = BaseObservableCache<PreviewModel>(cacheLimit: 500)
  ...
  static let videos = ObjectCache<SharedVideo>(cacheLimit: 500, diagnosticsPrefix: "videoCache")
